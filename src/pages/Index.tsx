    ...
    <div className="min-h-screen flex flex-col bg-gradient-wave bg-cover">
      <header className="container mx-auto py-6 px-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link to="/login">
            <Button className="dolphnet-gradient">Register</Button>
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-dolphin-500 to-ocean-400">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <Link to="/login">
              <Button size="lg" className="dolphnet-gradient">
                Get Started
